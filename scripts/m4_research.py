...
from research.experiments.m3_runner import default_m4_candidates, run_m3_research, write_m3_report


def main() -> None:
    parser = argparse.ArgumentParser(description="Run M4 alpha and regime research")
    ...
    parser.add_argument("--report", default="data/runtime/m4-research.json")
    parser.add_argument("--confirmation-report", default="data/runtime/m4-nautilus-confirmation.json")
